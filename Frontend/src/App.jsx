      ...
      <header className="border-b border-slate-800 bg-slate-900/50 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-slate-400">Role: <strong className="text-slate-200">Admin</strong></span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-slate-800/40 rounded-xl border border-slate-700/50 overflow-hidden shadow-xl">
          <div className="p-5 border-b border-slate-700/50 flex justify-between items-center bg-slate-800/20">
            ...
            <button className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-medium text-xs px-4 py-2 rounded-lg transition-colors">
              + New Project
            </button>
          </div>
